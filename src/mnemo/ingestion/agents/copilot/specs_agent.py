...
class CopilotSpecsAgent:
    ...
    def _process_one(self, path: Path, root: Path) -> Document | None:
        ...
        metadata: dict[str, Any] = {
            ...
            # Template-aligned sections (empty strings when absent).
            "user_story": record.get("user_story") or "",
            "acceptance_criteria": record.get("acceptance_criteria") or "",
            "test_scenarios_happy": record.get("test_scenarios_happy") or "",
            "test_scenarios_error": record.get("test_scenarios_error") or "",
            "test_scenarios_edge": record.get("test_scenarios_edge") or "",
            "acceptance_summary": record.get("acceptance_summary") or "",
            "context": record.get("context") or "",
            "decision": record.get("decision") or "",
            "consequences": record.get("consequences") or "",
            "goals": record.get("goals") or "",
            "constraints": record.get("constraints") or "",
            "stories_in_scope": record.get("stories_in_scope") or "",
            "template_compliance": record.get("template_compliance") or "n/a",
